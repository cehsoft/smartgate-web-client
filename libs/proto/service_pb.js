...
goog.exportSymbol('proto.main.ContainerTracking', null, global);
...
goog.exportSymbol('proto.main.ResListContainerTrackings', null, global);
 ...
 * @constructor
 */
proto.main.ContainerTracking = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.main.ContainerTracking, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.ContainerTracking.displayName = 'proto.main.ContainerTracking';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.main.ResListContainerTrackings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.main.ResListContainerTrackings.repeatedFields_, null);
};
goog.inherits(proto.main.ResListContainerTrackings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.ResListContainerTrackings.displayName = 'proto.main.ResListContainerTrackings';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.main.ContainerTracking.prototype.toObject = function(opt_includeInstance) {
  return proto.main.ContainerTracking.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.ContainerTracking} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ContainerTracking.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
    ocrid: jspb.Message.getFieldWithDefault(msg, 9, 0),
    score: jspb.Message.getFloatingPointFieldWithDefault(msg, 5, 0.0),
    containerid: jspb.Message.getFieldWithDefault(msg, 2, ""),
    imageurl: jspb.Message.getFieldWithDefault(msg, 3, ""),
    bic: jspb.Message.getFieldWithDefault(msg, 6, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.main.ContainerTracking}
 */
proto.main.ContainerTracking.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.ContainerTracking;
  return proto.main.ContainerTracking.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.ContainerTracking} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.ContainerTracking}
 */
proto.main.ContainerTracking.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.main.ContainerTracking.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.ContainerTracking.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.ContainerTracking} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ContainerTracking.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.main.ContainerTracking.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.main.ContainerTracking.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional int32 OCRID = 9;
 * @return {number}
 */
proto.main.ContainerTracking.prototype.getOcrid = function() {
 ...
 * @return {!proto.main.ContainerTracking} returns this
 */
proto.main.ContainerTracking.prototype.setOcrid = function(value) {
 ...
 * @return {string}
 */
proto.main.ContainerTracking.prototype.getContainerid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.main.ContainerTracking} returns this
 */
proto.main.ContainerTracking.prototype.setContainerid = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.main.ContainerTracking.prototype.getImageurl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.main.ContainerTracking} returns this
 */
proto.main.ContainerTracking.prototype.setImageurl = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.main.ContainerTracking.prototype.getCreatedat = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @const
 */
proto.main.ResListContainerTrackings.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.main.ResListContainerTrackings.prototype.toObject = function(opt_includeInstance) {
  return proto.main.ResListContainerTrackings.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.ResListContainerTrackings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ResListContainerTrackings.toObject = function(includeInstance, msg) {
  var f, obj = {
    status: (f = msg.getStatus()) && proto.main.ResStatus.toObject(includeInstance, f),
    total: jspb.Message.getFieldWithDefault(msg, 3, 0),
    trackingsList: jspb.Message.toObjectList(msg.getTrackingsList(),
    proto.main.ContainerTracking.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.main.ResListContainerTrackings}
 */
proto.main.ResListContainerTrackings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.ResListContainerTrackings;
  return proto.main.ResListContainerTrackings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.ResListContainerTrackings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.ResListContainerTrackings}
 */
proto.main.ResListContainerTrackings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      ...
      break;
    case 2:
      var value = new proto.main.ContainerTracking;
      reader.readMessage(value,proto.main.ContainerTracking.deserializeBinaryFromReader);
      msg.addTrackings(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.main.ResListContainerTrackings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.ResListContainerTrackings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.ResListContainerTrackings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ResListContainerTrackings.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f != null) {
    writer.writeMessage(
  ...
  f = message.getTrackingsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.main.ContainerTracking.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.main.ResStatus}
 */
proto.main.ResListContainerTrackings.prototype.getStatus = function() {
  return /** @type{?proto.main.ResStatus} */ (
    jspb.Message.getWrapperField(this, proto.main.ResStatus, 1));
};
...
/**
 * @param {?proto.main.ResStatus|undefined} value
 * @return {!proto.main.ResListContainerTrackings} returns this
*/
proto.main.ResListContainerTrackings.prototype.setStatus = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.main.ResListContainerTrackings} returns this
 */
proto.main.ResListContainerTrackings.prototype.clearStatus = function() {
  return this.setStatus(undefined);
};
 ...
 * @return {boolean}
 */
proto.main.ResListContainerTrackings.prototype.hasStatus = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.main.ResListContainerTrackings.prototype.getTotal = function() {
 ...
 * @return {!proto.main.ResListContainerTrackings} returns this
 */
proto.main.ResListContainerTrackings.prototype.setTotal = function(value) {
 ...
 * @return {!Array<!proto.main.ContainerTracking>}
 */
proto.main.ResListContainerTrackings.prototype.getTrackingsList = function() {
  return /** @type{!Array<!proto.main.ContainerTracking>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.main.ContainerTracking, 2));
};


/**
 * @param {!Array<!proto.main.ContainerTracking>} value
 * @return {!proto.main.ResListContainerTrackings} returns this
*/
proto.main.ResListContainerTrackings.prototype.setTrackingsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.main.ContainerTracking=} opt_value
 * @param {number=} opt_index
 * @return {!proto.main.ContainerTracking}
 */
proto.main.ResListContainerTrackings.prototype.addTrackings = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.main.ContainerTracking, opt_index);
};
 ...
 * @return {!proto.main.ResListContainerTrackings} returns this
 */
proto.main.ResListContainerTrackings.prototype.clearTrackingsList = function() {
  return this.setTrackingsList([]);
};
