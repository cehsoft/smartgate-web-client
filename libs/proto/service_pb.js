...
goog.exportSymbol('proto.main.ResConfirmContainerID', null, global);
 ...
 * @constructor
 */
proto.main.ResConfirmContainerID = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.main.ResConfirmContainerID, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.ResConfirmContainerID.displayName = 'proto.main.ResConfirmContainerID';
}
 ...
 * @return {!Object}
 */
proto.main.ResConfirmContainerID.prototype.toObject = function(opt_includeInstance) {
  return proto.main.ResConfirmContainerID.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.ResConfirmContainerID} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ResConfirmContainerID.toObject = function(includeInstance, msg) {
  var f, obj = {
    status: (f = msg.getStatus()) && proto.main.ResStatus.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.main.ResConfirmContainerID}
 */
proto.main.ResConfirmContainerID.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.ResConfirmContainerID;
  return proto.main.ResConfirmContainerID.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.ResConfirmContainerID} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.ResConfirmContainerID}
 */
proto.main.ResConfirmContainerID.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.main.ResConfirmContainerID.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.ResConfirmContainerID.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.ResConfirmContainerID} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ResConfirmContainerID.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.main.ResStatus}
 */
proto.main.ResConfirmContainerID.prototype.getStatus = function() {
  return /** @type{?proto.main.ResStatus} */ (
    jspb.Message.getWrapperField(this, proto.main.ResStatus, 1));
};
...
/**
 * @param {?proto.main.ResStatus|undefined} value
 * @return {!proto.main.ResConfirmContainerID} returns this
*/
proto.main.ResConfirmContainerID.prototype.setStatus = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.main.ResConfirmContainerID} returns this
 */
proto.main.ResConfirmContainerID.prototype.clearStatus = function() {
  return this.setStatus(undefined);
};
 ...
 * @return {boolean}
 */
proto.main.ResConfirmContainerID.prototype.hasStatus = function() {
  return jspb.Message.getField(this, 1) != null;
};
